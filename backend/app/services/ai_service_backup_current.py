...
class AIService:
    def __init__(self):
        ...
        if self.api_key and self.api_key != "get-your-free-gemini-api-key-from-ai.google.dev":
            ...
            print("⚠️  Using placeholder AI responses for endpoint testing")    def get_conversation_response(self, user_id: str, message: str, language: str, level: str, communication_language: Optional[str] = None) -> str:
